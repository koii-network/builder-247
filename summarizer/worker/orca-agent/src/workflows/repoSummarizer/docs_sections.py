DOCS_SECTIONS = {
    "library": [
        ...
        {
            "name": "Installation",
            "description": "Instructions for installing the library using relevant package managers "
            "(e.g., npm, pip, etc.)\n"
    ...
    "web_app": [
        {
            "name": "Project Overview",
            "description": "Describe the purpose and core functionality of the application\n"
            "Highlight key features and typical use cases\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Provide setup instructions to run the app locally\n"
        ...
        },
        {
            ...
            "description": "Briefly explain the purpose of major folders and files "
            "(e.g., `src/`, `public/`, `components/`)\n\n",
        },
        {
    ...
    "api_service": [
        {
            "name": "Project Overview",
            "description": "Describe the purpose of the API and its core functionality\n"
            "Highlight key features and typical use cases\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Provide setup instructions to run the service locally\n"
        ...
        {
            "name": "Project Structure",
            "description": "Explain key folders and files, such as `routes/`, `controllers/`, `models/`\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "mobile_app": [
        {
            "name": "Project Overview",
            "description": "Describe the purpose and core functionality of the app\n"
            "Highlight key features and intended user experience\n\n",
        },
        {
        ...
        {
            "name": "Getting Started",
            "description": "Provide setup instructions for running the app locally\n"
        ...
        {
            "name": "Project Structure",
            "description": "Briefly explain the layout of important folders and files "
            "(e.g., `src/`, `ios/`, `android/`, `lib/`)\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "tutorial": [
        {
            "name": "Overview",
            "description": "Summarize the goal of the tutorial and what users will learn\n"
            "List key topics or technologies covered\n"
            "Mention any prerequisites (e.g., knowledge of a language, tools to install)\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Provide step-by-step setup instructions\n"
        ...
        {
            "name": "Project Structure",
            "description": "Describe the layout of the repository and which files correspond to different "
            "tutorial stages\n\n",
        },
        {
    ...
    "template": (
        {
            "name": "Project Overview",
            "description": "Describe the purpose of this template and the type of projects it's meant for\n"
            "List key features, tools, or configurations included by default\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Provide instructions for cloning or copying the template\n"
        ...
        {
            "name": "Project Structure",
            "description": "Describe the layout of important directories and files\n"
    ...
    "cli_tool": [
        {
            "name": "Project Overview",
            "description": "Explain what the CLI tool does and why it's useful\n"
            "Mention common use cases or problems it solves\n\n",
        },
        {
            "name": "Installation",
            "description": "Provide steps to install the tool (e.g., npm, pip, Homebrew, binary download)\n"
        ...
        {
            "name": "Project Structure",
            "description": "Briefly describe key files or folders related to the CLI's source code\n\n",
        },
        {
            "name": "Contributing",
    ...
    "framework": [
        {
            "name": "Project Overview",
            "description": "Describe what the framework does and the type of projects it's built for\n"
            "Highlight key concepts and design philosophy (e.g., convention over configuration, modularity)\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Include steps for installing and initializing a new project using the framework\n"
        ...
        {
            "name": "Project Structure",
            "description": "Explain the directory layout of a typical project using the framework\n"
        ...
        {
            "name": "Contributing",
            "description": "Outline how contributors can report issues, add features, or "
            "build plugins for the framework\n\n",
        },
        {
            "name": "License",
            "description": "State the license type and link to the license file\n\n"
    ...
    "data_science": [
        {
            "name": "Project Overview",
            "description": "Explain the goal of the project (e.g., prediction, classification, analysis)\n"
        ...
        },
        {
            ...
            "description": "List dependencies and setup instructions (e.g., `requirements.txt`, `environment.yml`)\n"
            "Mention any additional setup (e.g., downloading data, creating folders)\n\n",
        },
        {
            "name": "Project Structure",
            "description": "Explain the layout of scripts, notebooks, data folders, and model outputs\n"
    ...
    "plugin": [
        {
            "name": "Overview",
            "description": "Describe what this plugin does and the host system it's built for\n"
            "List key features and benefits\n\n",
        },
        {
            "name": "Installation",
            "description": "Provide installation instructions specific to the host platform\n"
        ...
        {
            "name": "Project Structure",
            "description": "Briefly explain key files and folders\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "chrome_extension": [
        {
            "name": "Overview",
            "description": "Describe the purpose and features of the extension\n\n",
        },
        {
            "name": "Installation",
            "description": "Include instructions for loading the extension in Chrome "
            "(via the Extensions page or Chrome Web Store)\n"
        ...
        {
            "name": "Project Structure",
            "description": "Briefly describe key files like `manifest.json`, `background.js`, and popup components\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "jupyter_notebook": [
        {
            "name": "Overview",
            "description": "Describe the purpose of the notebooks and what they demonstrate or analyze\n\n",
        },
        {
            "name": "Getting Started",
            "description": "Provide instructions for setting up the environment "
            "(e.g., installing Jupyter, dependencies, virtualenv)\n"
    ...
    "infrastructure": [
        {
            "name": "Overview",
            "description": "Explain what infrastructure is being managed and its intended use\n\n",
        },
        {
            "name": "Setup",
            "description": "Describe any prerequisites (e.g., installing Docker, Terraform CLI, "
    ...
    "smart_contract": [
        {
            "name": "Overview",
            "description": "Explain the purpose and functionality of the smart contracts\n"
            "Mention the target blockchain platform\n\n",
        },
        {
            "name": "Installation and Setup",
            "description": "List dependencies and setup instructions (e.g., hardhat, anchor, solana-cli)\n"
        ...
        {
            "name": "Project Structure",
            "description": "Describe layout of contracts, migrations, and test files\n\n",
        },
        {
            "name": "License",
            "description": "State the license type and link to the license file\n\n"
    ...
    "dapp": [
        {
            "name": "Overview",
            "description": "Describe what the dApp does and the blockchain ecosystem it runs on\n"
        ...
        {
            "name": "Getting Started",
            "description": "Provide setup instructions for both frontend and backend\n"
    ...
    "game": [
        {
            "name": "Overview",
            "description": "Describe the game concept, genre, and platform (e.g., browser, desktop, mobile)\n"
            "Mention gameplay goals or mechanics\n\n",
        },
        {
            "name": "Installation and Setup",
            "description": "Provide instructions for installing dependencies and running the game\n"
        ...
        {
            "name": "Project Structure",
            "description": "Describe key files and folders (e.g., assets, levels, scripts)\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "desktop_app": [
        {
            "name": "Overview",
            "description": "Describe what the desktop app does and who it's for\n"
            "Mention platforms supported (e.g., Windows, macOS, Linux)\n\n",
        },
        {
            "name": "Installation and Setup",
            "description": "Provide platform-specific install/build instructions\n"
        ...
        {
            "name": "Project Structure",
            "description": "Describe key files and folders (e.g., main process, renderer process, assets)\n\n",
        },
        {
            "name": "Technologies Used",
    ...
    "dataset": [
        {
            "name": "Overview",
            "description": "Describe what the dataset contains and its intended purpose\n"
