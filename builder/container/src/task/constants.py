PROMPTS = {
    "setup_repository": "Please create a new branch and switch to it in the repository located at {repo_path}. "
    "Give the branch a name that describes the task: {todo}",
