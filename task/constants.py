PROMPTS = {
    ...
    "commit_push_create_pr": "Please commit and push using the {repo_path} path. Please create a pull request with the following details: todo {todo}, repo full name {repo_full_name}, head {head}, base {base}"
